...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "Categorias" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "CategoryManager", CategoryManager, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/laucaballero/Desktop/Lautaro/AndesCode/galeria_web/src/components/admin/CategoryManager", "client:component-export": "default" })} ` })}`;
}, "/Users/laucaballero/Desktop/Lautaro/AndesCode/galeria_web/src/pages/admin/categorias/index.astro", void 0);

const $$file = "/Users/laucaballero/Desktop/Lautaro/AndesCode/galeria_web/src/pages/admin/categorias/index.astro";
