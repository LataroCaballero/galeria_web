...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DvSbb_mJ.mjs';
import { manifest } from './manifest_CCfDgTkj.mjs';
...
const _args = {
    "middlewareSecret": "bde65491-323c-474f-a0ed-d3cac23be1d4",
