...
Cerrar Sesion
</button> </div> </aside> <!-- Mobile header --> <div class="md:hidden fixed top-0 left-0 right-0 z-50 bg-carbón text-crema px-4 py-3 flex items-center justify-between"> <a href="/admin" class="text-sm uppercase tracking-tightish font-bold">Admin</a> <div class="flex gap-4 text-xs"> <a href="/admin/productos" class="hover:opacity-70">Productos</a> <a href="/admin/categorias" class="hover:opacity-70">Categorias</a> <button id="logoutBtnMobile" class="hover:opacity-70 cursor-pointer">Salir</button> </div> </div> <!-- Main content --> <main class="flex-1 p-6 md:p-8 overflow-y-auto mt-12 md:mt-0"> ${renderSlot($$result, $$slots["default"])} </main> </div> ${renderScript($$result, "/Users/laucaballero/Desktop/Lautaro/AndesCode/galeria_web/src/layouts/AdminLayout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
}, "/Users/laucaballero/Desktop/Lautaro/AndesCode/galeria_web/src/layouts/AdminLayout.astro", void 0);
